                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="exams_id" class="form-control" id="">
                                                    <option value="{{ $question->exams_id }}">Kosongkan Jika Tidak
                                                        Mengganti
                                                        Ujian</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="multiple_choice_one" class="form-control"
                                                    value="{{ $question->multiple_choice_one }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="multiple_choice_two" class="form-control"
                                                    value="{{ $question->multiple_choice_two }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="multiple_choice_three" class="form-control"
                                                    value="{{ $question->multiple_choice_three }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="multiple_choice_four" class="form-control"
                                                    value="{{ $question->multiple_choice_four }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
